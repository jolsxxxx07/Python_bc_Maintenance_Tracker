...
$(document).ready(function () {
          ...
          $.ajax({
            ...
            url: '/ViewProductActivity?itemid='+localStorage.getItem("product"), 
            type: 'GET',
 ...
 //window.location.assign("/dashboard")
  ...
  dated +=products[product + 1]+","
   ...
   accumulator += dated + value;
      
  }

  localStorage.setItem("map",accumulator);

  document.getElementById("repair").innerHTML = repair;
  document.getElementById("main").innerHTML = maintenance;
